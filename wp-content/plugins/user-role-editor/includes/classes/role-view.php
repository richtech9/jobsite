...
class URE_Role_View extends URE_View {
    ...
    private function role_delete_prepare_html() {
        ...
        if ($roles_can_delete && count($roles_can_delete) > 0) {
            ...
            $this->role_delete_html .= '<option value="-1" style="color: #ee2b31;">' . esc_html__('Delete All Unused Roles', 'user-role-editor') . '</option>';
...
?>                   
                  <button id="ure_reset_roles_button" class="ure_toolbar_button" style="color: #ee2b31;" title="Reset Roles to its original state">Reset</button>
<?php
                    }
                }
?>
