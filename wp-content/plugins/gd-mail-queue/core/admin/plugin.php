...
class gdmaq_admin_core extends d4p_admin_core {
    ...
    public function screen_options_grid_rows_save($status, $option, $value) {
        if ($option == 'gdmaq_rows_per_page_log') {
            return $value;
        }
    ...
    public function screen_options_grid_rows_log() {
        $args = array(
            ...
            'default' => 25,
            'option' => 'gdmaq_rows_per_page_log'
        );
    ...
    public function get_template_tags() {
        return array_merge(array(
            ...
            '{{EMAIL_HEADER}}' => __("Header", "gd-mail-queue").' <strong>('.__("From Templates Parts Settings").')</strong>',
            '{{EMAIL_FOOTER}}' => __("Footer", "gd-mail-queue").' <strong>('.__("From Templates Parts Settings").')</strong>',
