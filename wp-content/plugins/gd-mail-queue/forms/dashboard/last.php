    ...
    <div class="d4p-group-stats">
        <ul class="d4p-items-list">
            <li class="liner">
                ...
                <span><?php $val = gdmaq_settings()->get_statistics('last_queue_started'); echo $val == 0 ? __("Never", "gd-mail-queue") : date('Y-m-d H:i:s', gdmaq()->datetime->timestamp_gmt_to_local($val)); ?></span>
            </li>
            <li>
    ...
    <div class="d4p-group-inner">
        <ul class="d4p-items-list" style="margin-top: 0">
            <li>
                ...
                <span><?php echo gdmaq_settings()->get_statistics('last_queue_sent'); ?></span>
            </li>
            <li>
                <strong><i class="fa fa-envelope fa-fw"></i> <?php _e("Emails Failed", "gd-mail-queue"); ?></strong>
                <span><?php echo gdmaq_settings()->get_statistics('last_queue_failed'); ?></span>
            </li>
            <li>
                <strong><i class="fa fa-paperclip fa-fw"></i> <?php _e("Attachments Sent", "gd-mail-queue"); ?></strong>
                <span><?php echo gdmaq_settings()->get_statistics('last_queue_attachments'); ?></span>
            </li>
        </ul><div class="d4p-clearfix"></div>
    </div>
</div>
