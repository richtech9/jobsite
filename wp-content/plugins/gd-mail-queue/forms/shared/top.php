    ...
    switch ($msg) {
        ...
        case 'retried':
            if ($count === false) {
                ...
                $_message = sprintf(_n("%s email has been added to the queue to retry sending.", "%s emails have been added to the queue to retry sending.", $count), $count);
            }
            break;
        case 'deleted':
            if ($count === false) {
                ...
                $_message = sprintf(_n("%s entry has been deleted.", "%s entries have been deleted.", $count), $count);
            }
            break;
        default:
