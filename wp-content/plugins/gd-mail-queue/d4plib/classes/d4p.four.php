                        ...
                        $render.= '<div class="dev4press-recommend-plugin" style="border-color: '.$plugin->color_dark.'; background-color: '.$plugin->color.'">';
                            ...
                            $render.= '<div class="dev4press-plugin-inner">';
                                ...
                                $render.= '<div class="dev4press-plugin-links">';
                                    $render.= '<a target="_blank" class="button-primary dev4press-buynow" href="'.$this->_url($plugin->url_buy, $panel).'">Buy</a>';

                                    if ($plugin->url_micro != '') {
                                        $render.= '<a target="_blank" class="button-secondary" href="'.$this->_url($plugin->url_micro, $panel).'">HomePage</a>';
                                    }
