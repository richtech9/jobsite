...
class CurlFactory
{
    ...
    public function __invoke(array $request, $handle = null)
    {
        ...
        curl_setopt_array($handle, $options);//this-task add wait time if not set
    ...
    private function getDefaultOptions(array $request, array &$headers)
    {
        ...
        $options = [
            ...
            CURLOPT_CONNECTTIMEOUT => 5, //code-notes curl should not spend more than 5 seconds trying to connect to the ES
