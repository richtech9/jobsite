;(function($) {
    ...
    $.extend(EmojiPicker.prototype, {
        ...
        init: function() {
            ...
            var ewrap = $(parent).hasClass('emojiPickerIconWrap');
            if(ewrap == false) {
                this.addPickerIcon();
                this.createPicker();
            }
                ...
                this.$wrapper = $(parent);
                this.$icon = $(parent).find('div.emojiPickerIcon');
                this.$packer = this.createPicker();

                //this.$packer = $(document.body).find('div.emojiPicker');
            }
            this.listen();
        },
