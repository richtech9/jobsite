...
class LibConException extends RuntimeException {}
...
class LibCon {
     ...
     *  one of the values in the @see LibCon::FORMATS
     * </p>
     *
     * @param string|null $subtype <p>
     *  NULL OR one of the values in the @see LibCon::SUBTYPES_SINGLE_ARRAY
     * </p>
     * @param string|null $detail <p>
     *   NULL or one of the values returned by @see LibCon::get_details_for_subformat
     ...
     * </p>
     *
     * @throws LibConException if one of the conditions is not met
     * @since 0.2.2
     */
    public function __construct($format,$subtype = null,$detail = null) {
        ...
        if ( $subtype && in_array( $subtype, self::BOOL_TEXT_SUBTYPES ) ) {
            ...
            if ( empty( $detail ) ) {
                ...
                if ( ! $b_found ) {
                    throw new LibConException( "Detail given was [$detail],  not found by case insensitive search in the php timezone list. see http://php.net/manual/en/timezones.php" );
                }
            }
     ...
     */
    public static function parseFormatString($format_string) {
     ...
     * @since 0.2.2
     */
    public static function get_subtype_for_format($format) {
        $ret = [];
     ...
     * @since 0.2.2
     */
    public static function get_details_for_subformat($subformat) {
     ...
     *
     * @param null|bool|integer|float|string|array|stdClass $what
    ...
    protected static function convert_var_to_carbon($what,$timezone) {
        ...
        try {
            ...
            if ( is_numeric( $what ) ) {
                ...
                if (is_object($what) && ($what instanceof DateTimeInterface )) {
    ...
    protected static function convert_var_to_subtype($what,$subtype,$detail) {
     ...
     * @since 0.2.2
     */
    protected static function convert_var_to_type($what,$type) {
...
class LibConTestStringAndFull {
    ...
    /** @noinspection PhpUnused */
    /**
     * LibConTestStringAndFull constructor.
     * @param * $foo
     */
    public function __construct($foo)
    {
