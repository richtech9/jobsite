...
class JsonHelper {
     ...
     * @param string|integer|float|null|boolean|stdClass|array $var
     ...
     */
    public static function tags_to_n($string,$replace_nobreak_space= false,$b_remove_existing_newlines = true) {
