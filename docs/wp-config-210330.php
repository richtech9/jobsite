...
define( 'DB_NAME', 'peerok_millionusers' );
#define( 'DB_NAME', 'peerok_small' );
...
//turns off all auto updates. You will need to be responsible for manually updating any security updates after doing this
...
function EarlyPreflightLoad() {
    $b_did_not_load_in_class = true;
    $path_we_want = ABSPATH . 'wp-content/themes/the-translator/includes/global-hooks/FreelinguistPreFlightCheck.php';
    ...
    if ($b_did_not_load_in_class) {return;}
