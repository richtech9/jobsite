...
function wpmu_signup_stylesheet() {
	...
	<style type="text/css">
		...
		.mu_register .error { font-weight: 600; padding: 10px; color: #666; background: #FFEBE8; border: 1px solid #CC0000; }
		...
		.mu_register .mu_alert { font-weight: 600; padding: 10px; color: #666; background: #ffffe0; border: 1px solid #e6db55; }
	</style>
	<?php
}
